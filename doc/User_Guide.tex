...
\begin{document}
	...
	\begin{enumerate}
		...
		\textit{Note}: Ensure that the linker flags in the Makefile (\texttt{-lfftw3 -lm}) match your system's configuration.
	...
	\subsection{Main Program (\texttt{main.f90})}
	...
	\begin{enumerate}
		\item Number of total atoms
		\item First 4 atoms: solute particles
		\item Remaining atoms: solvent particles.
	\end{enumerate}
	...
	\begin{itemize}
		...
		\begin{itemize}
			\item Column 1: time
			\item Columns 2-13: friction tensor components for the 4 solute particles (diagonal component for each).
		\end{itemize}
	\end{itemize}
